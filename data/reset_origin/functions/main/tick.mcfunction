...
execute as @e[type=player,scores{y_or_CD=1..}] if entity @e[type=armor_stand,scores={y_or_CD=0},tag=y_or_ACTIVE] as @e[type=armor_stand,scores={y_or_CD=0},tag=y_or_ACTIVE] run function reset_origin:markers/timesup
