...
execute as @e[type=player,scores={y_or_CD=1..}] if score @s y_or_CD = @e[type=armor_stand,tag=y_or_ACTIVE,scores={y_or_CD=0},limit=1] as @e[type=armor_stand,scores={y_or_CD=0},tag=y_or_ACTIVE] run function reset_origin:markers/timesup
