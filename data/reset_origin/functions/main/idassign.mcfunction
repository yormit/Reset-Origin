forceload add ~-15 ~-15 ~15 ~15
scoreboard players operation @s y_or_ID = $y_or_IDmax y_or_ID
execute in minecraft:overworld positioned 1 1 1 run summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Small:1b,armor_stand:1b,Invisible:1b,PersistenceRequired:1b,Tags:["y_or_Mnew","y_or"]}
